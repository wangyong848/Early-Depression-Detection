...
def load_model_path(root=None, version=None, v_num=None, best=False):
    """
    Load model
    :param root: The root directory of checkpoints. It can also be a model ckpt file. Then the function will return it.
    :param version:
    :param v_num: The version's number that you are going to load.
    :param best: Whether return the best model.
    :return:
    """
